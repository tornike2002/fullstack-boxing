...
function AnnouncementContent({ title, description, image }: AnnouncementTypes) {
  return (
    ...
    >
      <motion.div variants={fadeInVariant} className="text-white flex flex-col items-center gap-2">
        ...
        <Link href={"/contact"}>
          <button
            className="text-white text-sm font-semibold py-3 px-10 border-white border hover:bg-white hover:text-black transition-all duration-300 ease mt-5"
          >
            LEARN MORE & ABOUT US
          </button>
        </Link>
